        ...
        >
            <div className="container px-6 md:px-10 mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    {/* Left: portrait photo */}
                    <div className="scroll-reveal relative w-full aspect-[3/4] rounded-3xl overflow-hidden bg-[#e4e2dd] order-2 lg:order-1">
                        <Image
                            src="/produ/talent-warm-light.jpg"
                            alt="Cala Studio — sumate al equipo"
                            fill
                    ...
                    <div className="order-1 lg:order-2 text-center lg:text-left">
                        ...
                        <p className="scroll-reveal text-lg text-[#4a403a]/70 leading-relaxed font-light max-w-xl lg:mx-0 mx-auto mt-8">
                        ...
                        {/* CTA */}
                        <div className="scroll-reveal mt-10 flex justify-center lg:justify-start">
                            <Link
